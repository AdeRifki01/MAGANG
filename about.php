...
<!-- HERO -->
    <section class="d-flex align-items-center text-white text-center"
        ...
        url('/eresa/asset/img/eresa/ECS_landscape.png');
                    ...
                    <div id="carouselEresa" class="carousel slide">
                        <div class="carousel-inner rounded-4 shadow">
                            <div class="carousel-item active">
                                <img src="/eresa/asset/img/portofolio/MockUp_1.png"
                                    class="img-fluid shadow" style="max-height:300px; transition:0.5s;">
                            </div>
                            <div class="carousel-item">
                                <img src="/eresa/asset/img/portofolio/MockUp_2.png"
                                    class="img-fluid shadow" style="max-height:300px; transition:0.5s;">
                            </div>
                        </div>
                    </div>
...
<!-- SCRIPT -->
    ...
    <script>
    const carousel = new bootstrap.Carousel('#carouselEresa', {
        interval: 3000,   // lebih cepat = lebih modern feel
        ride: 'carousel',
